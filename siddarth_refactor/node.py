...
if TYPE_CHECKING:
    ...
    from siddarth_refactor.consensus import ConsensusProtocol
...
class NodeBase(ABC):
    ...
    def __init__(self, env: simpy.Environment, node_id: int, network: 'BlockchainSimulator', 
        ...
        self.mining_difficulty = 6 # Default difficulty for PoW #TODO: Set in simulator per node
    ...
    def consensus_step(self):
        ...
        consensus_output = self.consensus_protocol.execute_consensus(self)
